...
public class CityMapper extends MainMapper {
    ...
    public static List<Order> getAll() {
        String sql = "SELECT `id`, `weight`, `width`, `height`, `length`, `from_city_id`, `from_address`, `to_city_id`, `to_address`, `recipient_name`, `recipient_phone`, `cost`, `status`, `client_id`, `carrier_id`, `date_create` FROM `orders`";
    ...
    public static Order getById(int id) {
        String sql = "SELECT `id`, `weight`, `width`, `height`, `length`, `from_city_id`, `from_address`, `to_city_id`, `to_address`, `recipient_name`, `recipient_phone`, `cost`, `status`, `client_id`, `carrier_id`, `date_create` FROM `orders` WHERE `id` = :id";
        try (Connection con = sql2o.open()) {
            return con.createQuery(sql)
                    .addParameter("id", id)
